<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    <header class="py-6 bg-brown text-white font-bold tracking-wide">
        <div class="container mx-auto flex justify-between items-center px-8 md:px-8 lg:px-8 w-full">
          <h1 class="text-2xl text-center">Catcafe <br> mofumofu</h1>
          ...
          <nav>
            <button id="button" type="button" class="absolute z-10 top-8 right-10 md:hidden">
              ...
              <div id="xmark" class="hidden mt-2 mr-4">
            ...
            <ul id="menu" class="z-0 fixed top-0 left-0 w-full py-20 text-center bg-body translate-x-full transition ease-linear h-full">
              <li><a href="#concept" class="block py-2 px-4 text-lg w-full text-center hover:bg-gray-200 transition-all duration-500">concept</a></li>
              <li><a href="#news" class="block py-2 px-4 text-lg w-full text-center hover:bg-gray-200 transition-all duration-500">news</a></li>
              ...
              <li><a href="#reserve" class="block py-2 px-4 text-lg w-full text-center hover:bg-gray-200 transition-all duration-500">reserve</a></li>
            </ul>
          </nav>
      </header>
